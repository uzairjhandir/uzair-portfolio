...
class PortfolioSitemapSource implements SitemapSourceInterface
{
    public function section(): string         { return 'portfolio'; }
    public function label(): string           { return 'Portfolio Projects'; }
