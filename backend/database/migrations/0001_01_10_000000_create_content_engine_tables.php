...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Not guarded with Schema::hasTable(): on this stack's SQLite/PHP
        // combo, hasTable() unreliably returned false for a table this same
        // migration had just created, causing "table already exists" on
        // every fresh install. This table is only ever created here.
        ...
        Schema::create('content_activity_logs', function (Blueprint $table) {
                ...
                $table->timestamp('created_at');
                // Note: morphs() already creates the index on loggable_type + loggable_id
            });
